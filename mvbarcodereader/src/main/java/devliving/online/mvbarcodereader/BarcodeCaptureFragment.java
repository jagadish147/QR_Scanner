        ...
        flashToggle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCameraSource.setFlashMode(mFlashOn ? Camera.Parameters.FLASH_MODE_OFF : Camera.Parameters.FLASH_MODE_TORCH)) {
                    mFlashOn = !mFlashOn;
                    flashToggle.setColorFilter(mFlashOn ? getResources().getColor(R.color.black) : getResources().getColor(R.color.white));
                    flashToggle.setBackground(mFlashOn ? AppCompatResources.getDrawable(getContext(),R.drawable.bg_circular_light_gray) : null);
                    flashToggle.setImageResource(mFlashOn ? R.drawable.ic_flash : R.drawable.ic_flash);
                }
            }
        });
